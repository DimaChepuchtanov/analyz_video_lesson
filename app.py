...
class Main(Tk):
    def __init__(self, is_internet=False, screenName=None, baseName=None, className="Tk", useTk=True, sync=False, use=None, uid=0):
        ...
        CTkLabel(self.recog_list, text="Записи от ", font=CTkFont("Open Sans", 16)).place(x=15, y=8)
        ...
        CTkLabel(self.user_profile, text=f"Uid: {str(0 * (7-self.uid)) + str(self.uid)}", font=CTkFont("Open Sans", 14), height=18).place(x=55, y=40)
